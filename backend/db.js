...
const DB_PATH = process.env.VERCEL
  ...
  : path.join(__dirname, 'campusgrid.db');
...
function seedDb() {
  ...
  insertUser.run('sath@campusgrid.edu', hash, 'Sath', 'RFID-SATH-001');
  insertUser.run('demo@campusgrid.edu', hash, 'Demo User', 'RFID-DEMO-002');
